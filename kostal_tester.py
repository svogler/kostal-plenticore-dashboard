...
#           python 3.5   
#           pymodbus 2.10
# Please change the IP address of your Inverter (e.g. 192.168.178.58 and Port (default 1502) to suite your environment - see below)
#
import pymodbus
...
class kostal_modbusquery:
    def __init__(self):
        ...
        self.inverter_ip="192.168.178.58"
